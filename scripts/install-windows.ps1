...
Write-Host ""
Write-Host "With a licensed NEC-5 (EZNEC Pro+ keeps it in its Docs folder as NEC5CL_x13.exe), set this in the SAME window before starting:"
Write-Host "    `$env:NEC5_EXE = 'C:\EZNEC 7.0\Docs\NEC5CL_x13.exe'"
