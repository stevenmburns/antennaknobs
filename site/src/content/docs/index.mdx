...
<Card title="New in v0.69.0" icon="star">
  **Buried radial screens solve 4× faster, and the radial cap is gone.** A
  ...
  2.4 s to 1.1 s, and a 48-radial screen now solves on the hosted app in
  under 20 s where it used to refuse outright — level with a licensed
  NEC-5's wall on the same deck. Same impedance to every printed digit. Underneath:
