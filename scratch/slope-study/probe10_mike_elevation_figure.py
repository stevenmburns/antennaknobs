...
def main():
    ...
    if utd:
        caption = common + (
            ...
            "the specular point crossed from the slope onto the plain, are closed by the diffraction "
            "term at that same break: the largest jump between adjacent whole degrees across the seam "
            "falls from 3.03 dB to 0.18 mid-slope and 2.01 to 0.29 at the crest. A facet model is "
            "discontinuous there and a real hill is not. "
