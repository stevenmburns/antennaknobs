...
axes[0].annotate(
    "electrostatic referee: −370.5 kΩ (858.7 pF)",
    xy=(60, X_REFEREE),
    xytext=(0, 5),
    textcoords="offset points",
    fontsize=8.7,
...
fig.suptitle(
    "W7EL's coupled-loop model (500 Hz) — the four clean engines, post-#518\n"
    "one limit: NEC-5, razor, bs1, bs2 and the electrostatic referee agree",
    color=INK,
    fontsize=11,
)
fig.tight_layout(rect=(0, 0, 1, 0.91))
fig.savefig(HERE / "coupled-loop-convergence.png", dpi=160, facecolor=SURFACE)
